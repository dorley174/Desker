    ...
    <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-2 text-sm text-muted-foreground">
          ...
          <span className="rounded-full border px-3 py-1">SQLite + JWT</span>
        </div>
      </div>
      ...
      <Card className="border-primary/20 bg-gradient-to-br from-card to-muted/40 shadow-xl">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="rounded-xl border bg-background p-4">
            <div className="flex items-center gap-2 font-semibold text-foreground"><ShieldCheck className="h-4 w-4" /> Серверный режим</div>
            <p className="mt-2">Все ключевые сценарии работают через backend: регистрация, логин, история бронирований, слоты и профиль. Данные хранятся в общей БД, а не в localStorage браузера.</p>
          </div>
          <p>
